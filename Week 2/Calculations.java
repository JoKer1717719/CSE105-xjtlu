...
//        System.out.println(num1 + "*" + num2 + "+" + num3 + "-" + num4 + "/" + num4 + "= " + result );
          ...
          //Variable Types and Calculations – Ints and Mods
          int num1 = 2;
          int num2 = 3;
          int solution1;
          solution1 = num1 + num2;
          ...
          //Variable Types and Calculations – Doubles and Operator Precedence
          double calcVal1 = 4;
          double calcVal2 = 8;
          double calcVal3 = -1;
          ...
          //Variable Types and Calculations – Maths and Randoms
          double pi = Math.PI ;
